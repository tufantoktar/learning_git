...
class FundMetric(Base):
    ...
    fund_size_latest = Column(Float, nullable=True)
    investor_count_latest = Column(Float, nullable=True)
    fund_size_change_1d = Column(Float, nullable=True)
    fund_size_change_1w = Column(Float, nullable=True)
    fund_size_change_1m = Column(Float, nullable=True)
    investor_count_change_1w = Column(Float, nullable=True)
    investor_count_change_1m = Column(Float, nullable=True)
    estimated_net_flow_1d = Column(Float, nullable=True)
    estimated_net_flow_1w = Column(Float, nullable=True)
    estimated_net_flow_1m = Column(Float, nullable=True)
    money_flow_score = Column(Float, nullable=True)
    money_flow_label = Column(String(64), nullable=True)
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow)
    updated_at = Column(DateTime, nullable=False, default=datetime.utcnow, onupdate=datetime.utcnow)
